...
aliases:
  ...
  - /building-blocks/share-your-results-and-project/data-reporting/regression-analysis/
---
...
- A concrete example on how to evaluate model assumptions (mean residuals is 0, residuals are normally distributed, homoscedascticiy) can be found at the building block [Evaluate Model Assumptions ](/building-blocks/analyze-data/regressions/model-assumptions/).
